...
此为该AliceInCradle_ver028.X.DGLAB改版，但是适配ver029！
...
将.\CS2\UI\UIManager.cs中加入新的输入框，这样便可在游戏中按F10唤起的菜单中更改新功能的倍率参数（也可以直接在游戏目录下AliceInCradle_ver029\BepInEx\config\AliceInCradle.DGLAB.cfg文件中更改）
```
